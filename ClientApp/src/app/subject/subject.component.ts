...
const ELEMENT_DATA: PeriodicElement[] = [
  {id: 1, name: 'Jerry Smith', age: 22, weight:68, height: 152, bmr: 1525},
  {id: 2, name: 'Jim Hanson', age: 35, weight:85, height: 170, bmr: 1550},
  {id: 3, name: 'Larry James', age: 66, weight: 90, height: 155, bmr: 1653.75},
  {id: 4, name: 'Simon Jimenez', age: 44, weight:90, height: 200, bmr: 1935},
  ...
  {id: 11, name: 'Mel Robbins', age: 22, weight:59, height: 152, bmr: 1435},
  ...
  {id: 19, name: 'Christiano Jones', age: 19, weight:59, height: 168, bmr: 1550},
